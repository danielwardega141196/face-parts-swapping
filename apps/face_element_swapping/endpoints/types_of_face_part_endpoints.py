...
FourEndpointsOfANose = namedtuple(
    "FourEndpointsOfANose",
    [
...
SixEndpointsOfANose = namedtuple(
    "SixEndpointsOfANose",
    [
        "bottom_left_endpoint",
        "bottom_right_endpoint",
...
EndpointsOfLips = namedtuple(
    "EndpointsOfLips",
    ["left_endpoint", "top_endpoint", "right_endpoint", "bottom_endpoint"],
)
