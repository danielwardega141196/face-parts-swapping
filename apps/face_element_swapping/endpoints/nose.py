from .helpers import (
    ...
    point_dividing_a_line_segment,
)
from .settings import SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE
...
class GetEndpointsOfANose:
    ...
    def get_bottom_left_and_bottom_right_endpoints(face_landmarks):
        ...
        left_point_of_the_bottom_straight = point_dividing_a_line_segment(
            A=face_landmarks["nose_tip"][
                SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                    "INDEX_OF_THE_LEFTMOST_LANDMARK_OF_THE_TOP_LIP"
                ]
            ],
            ...
            offset_from_A=SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "DISTANCE_BETWEEN_THE_NOSE_TIP_AND_THE_TOP_LIP"
            ],
        )

        right_point_of_the_bottom_straight = point_dividing_a_line_segment(
            A=face_landmarks["nose_tip"][
                SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                    "INDEX_OF_THE_RIGHTMOST_LANDMARK_OF_THE_NOSE_TIP"
                ]
            ],
            B=face_landmarks["top_lip"][
                SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
        ...
        bottom_left_endpoint = point_along_a_line_distanced_from_another_point(
            A=left_point_of_the_bottom_straight,
            B=right_point_of_the_bottom_straight,
            offset_from_A=SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "OFFSET_FROM_THE_LINE_BETWEEN_THE_NOSE_AND_THE_LIPS"
            ],
        )

        bottom_right_endpoint = point_along_a_line_distanced_from_another_point(
            A=right_point_of_the_bottom_straight,
    ...
    def get_eyebrows_endpoints(face_landmarks):
        ...
        the_rightmost_landmark_of_the_left_eyebrow = face_landmarks["left_eyebrow"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "INDEX_OF_THE_RIGHTMOST_LANDMARK_OF_THE_LEFT_EYEBROW"
            ]
        ]
        the_leftmost_landmark_of_the_right_eyebrow = face_landmarks["right_eyebrow"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "INDEX_OF_THE_LEFTMOST_LANDMARK_OF_THE_RIGHT_EYEBROW"
            ]
        ]

        return (
            the_rightmost_landmark_of_the_left_eyebrow,
            the_leftmost_landmark_of_the_right_eyebrow,
        )
    ...
    def get_four_endpoints(face_landmarks):
        ...
        (
            the_rightmost_landmark_of_left_eyebrow,
            the_leftmost_landmark_of_right_eyebrow,
        ) = GetEndpointsOfANose.get_eyebrows_endpoints(face_landmarks=face_landmarks)
        (
            bottom_left_endpoint,
            bottom_right_endpoint,
        ) = GetEndpointsOfANose.get_bottom_left_and_bottom_right_endpoints(
            face_landmarks=face_landmarks
        )

        top_left_endpoint = point_along_a_line_distanced_from_another_point(
            A=the_rightmost_landmark_of_left_eyebrow,
            B=bottom_left_endpoint,
            offset_from_A=SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "OFFSET_FROM_THE_EYEBROWS"
            ],
        )

        top_right_endpoint = point_along_a_line_distanced_from_another_point(
            A=the_leftmost_landmark_of_right_eyebrow,
        ...
        return FourEndpointsOfANose(
            bottom_left_endpoint=bottom_left_endpoint,
    ...
    def get_middle_left_and_middle_right_endpoints(face_landmarks):
        ...
        the_rightmost_landmark_of_the_left_eye = face_landmarks["left_eye"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "INDEX_OF_THE_RIGHTMOST_LANDMARK_OF_THE_LEFT_EYE"
            ]
        ]
        the_leftmost_landmark_of_the_right_eye = face_landmarks["right_eye"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "INDEX_OF_THE_LEFTMOST_LANDMARK_OF_THE_RIGHT_EYE"
            ]
        ]

        middle_left_endpoint = point_dividing_a_line_segment(
            A=the_rightmost_landmark_of_the_left_eye,
            B=the_leftmost_landmark_of_the_right_eye,
            offset_from_A=SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "OFFSET_FROM_THE_ENDPOINTS_OF_THE_EYES"
            ],
        )

        middle_right_endpoint = point_dividing_a_line_segment(
            A=the_leftmost_landmark_of_the_right_eye,
            B=the_rightmost_landmark_of_the_left_eye,
            offset_from_A=SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
                "OFFSET_FROM_THE_ENDPOINTS_OF_THE_EYES"
            ],
        )
    ...
    def get_six_endpoints(face_landmarks):
        ...
        ) = GetEndpointsOfANose.get_middle_left_and_middle_right_endpoints(
            face_landmarks=face_landmarks
        )
        (
            top_left_endpoint,
    ...
    def get_endpoints_of_a_nose(face_landmarks, six_endpoints_mode=True):
        ...
        """
        nose_endpoints = {
            "four_endpoints": GetEndpointsOfANose.get_four_endpoints(
                face_landmarks=face_landmarks
            )
        }
        if six_endpoints_mode:
            nose_endpoints["six_endpoints"] = GetEndpointsOfANose.get_six_endpoints(
                face_landmarks=face_landmarks
            )
