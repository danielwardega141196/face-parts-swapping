...
from .types_of_face_part_endpoints import FourEndpointsOfANose, \
    SixEndpointsOfANose
...
class GetEndpointsOfANose:
    ...
    def get_bottom_left_and_bottom_right_endpoints(face_landmarks):
        ...
        left_point_of_the_bottom_straight = point_dividing_a_line_segment(A=face_landmarks["nose_tip"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE["INDEX_OF_THE_LEFTMOST_LANDMARK_OF_THE_TOP_LIP"]],
        ...
        right_point_of_the_bottom_straight = point_dividing_a_line_segment(A=face_landmarks["nose_tip"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE["INDEX_OF_THE_RIGHTMOST_LANDMARK_OF_THE_NOSE_TIP"]],
                                                                           B=face_landmarks["top_lip"][
                                                                               SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE[
    ...
    def get_eyebrows_endpoints(face_landmarks):
        ...
        the_rightmost_landmark_of_the_left_eyebrow = face_landmarks["left_eyebrow"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE["INDEX_OF_THE_RIGHTMOST_LANDMARK_OF_THE_LEFT_EYEBROW"]]
        the_leftmost_landmark_of_the_right_eyebrow = face_landmarks["right_eyebrow"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE["INDEX_OF_THE_LEFTMOST_LANDMARK_OF_THE_RIGHT_EYEBROW"]]

        return the_rightmost_landmark_of_the_left_eyebrow, the_leftmost_landmark_of_the_right_eyebrow
    ...
    def get_middle_left_and_middle_right_endpoints(face_landmarks):
        ...
        the_rightmost_landmark_of_the_left_eye = face_landmarks["left_eye"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE["INDEX_OF_THE_RIGHTMOST_LANDMARK_OF_THE_LEFT_EYE"]]
        the_leftmost_landmark_of_the_right_eye = face_landmarks["right_eye"][
            SETTINGS_OF_THE_ENDPOINTS_OF_A_NOSE["INDEX_OF_THE_LEFTMOST_LANDMARK_OF_THE_RIGHT_EYE"]]

        middle_left_endpoint = point_dividing_a_line_segment(A=the_rightmost_landmark_of_the_left_eye,
        ...
        middle_right_endpoint = point_dividing_a_line_segment(A=the_leftmost_landmark_of_the_right_eye,
