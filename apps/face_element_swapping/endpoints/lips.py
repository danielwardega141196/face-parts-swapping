...
from .settings import (
    MODE_OF_THE_LEFTMOST_POINT,
    MODE_OF_THE_RIGHTMOST_POINT,
...
class GetEndpointsOfLips:
    ...
    def get_top_endpoint_of_lips(face_landmarks):
        ...
        the_lowest_landmark_of_the_nose_tip = face_landmarks["nose_tip"][
            SETTINGS_OF_THE_ENDPOINTS_OF_LIPS[
                "INDEX_OF_THE_LOWEST_LANDMARK_OF_THE_NOSE_TIP"
            ]
        ]

        the_highest_landmark_of_the_top_lip = face_landmarks["top_lip"][
            SETTINGS_OF_THE_ENDPOINTS_OF_LIPS[
                "INDEX_OF_THE_HIGHEST_LANDMARK_OF_THE_TOP_LIP"
            ]
        ]

        top_endpoint_of_lips = point_dividing_a_line_segment(
            A=the_lowest_landmark_of_the_nose_tip,
    ...
    def get_bottom_endpoint_of_lips(face_landmarks):
        ...
        the_lowest_landmark_of_chin = face_landmarks["chin"][
            SETTINGS_OF_THE_ENDPOINTS_OF_LIPS[
                "INDEX_OF_THE_LOWEST_LANDMARK_OF_THE_CHIN"
            ]
        ]
        the_lowest_landmark_of_bottom_lip = face_landmarks["bottom_lip"][
            SETTINGS_OF_THE_ENDPOINTS_OF_LIPS[
                "INDEX_OF_THE_LOWEST_LANDMARK_OF_THE_BOTTOM_LIP"
            ]
        ]

        bottom_endpoint_of_lips = point_dividing_a_line_segment(
            A=the_lowest_landmark_of_bottom_lip,
    ...
    def get_the_leftmost_and_the_rightmost_points_of_lips(face_landmarks):
        ...
        the_leftmost_point_of_lips = find_endpoint(
            coordinates=both_lips, mode=MODE_OF_THE_LEFTMOST_POINT
        )
        # Of all the points regarding lips we choose the rightmost point.
        the_rightmost_point_of_lips = find_endpoint(
            coordinates=both_lips, mode=MODE_OF_THE_RIGHTMOST_POINT
        )
    ...
    def get_left_endpoint_of_lips(face_landmarks):
        ...
        """
        (
            the_leftmost_point_of_lips,
            the_rightmost_point_of_lips,
        ) = GetEndpointsOfLips.get_the_leftmost_and_the_rightmost_points_of_lips(
            face_landmarks=face_landmarks
        )
        left_endpoint_of_lips = point_along_a_line_distanced_from_another_point(
            A=the_leftmost_point_of_lips,
    ...
    def get_right_endpoint_of_lips(face_landmarks):
        ...
        right_endpoint_of_lips = point_along_a_line_distanced_from_another_point(
            A=the_rightmost_point_of_lips,
    ...
    def get_endpoints_of_lips(face_landmarks):
        ...
        left_endpoint_of_lips = GetEndpointsOfLips.get_left_endpoint_of_lips(
            face_landmarks=face_landmarks
        )
        top_endpoint_of_lips = GetEndpointsOfLips.get_top_endpoint_of_lips(
            face_landmarks=face_landmarks
        )
        right_endpoint_of_lips = GetEndpointsOfLips.get_right_endpoint_of_lips(
            face_landmarks=face_landmarks
        )
        bottom_endpoint_of_lips = GetEndpointsOfLips.get_bottom_endpoint_of_lips(
            face_landmarks=face_landmarks
        )

        return EndpointsOfLips(
            left_endpoint=left_endpoint_of_lips,
